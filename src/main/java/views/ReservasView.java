...
public class ReservasView extends JFrame {
	...
	public ReservasView() {
		...
		btnsiguiente.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				if (isRegisterFilled()) {
					ReservaDao reservaDao = new ReservaDao(JPAUtils.getEntityManager());
	...
	private void setValor() {
		if (isRegisterFilled()) {
			reserva.setFechaEntrada(ReservasView.txtFechaEntrada.getDate());
			reserva.setFechaSalida(ReservasView.txtFechaSalida.getDate());
			reserva.setValor();
	...
	private boolean isRegisterFilled() {
		return ReservasView.txtFechaEntrada.getDate() != null && ReservasView.txtFechaSalida.getDate() != null;
	}
